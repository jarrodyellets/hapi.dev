        ...
        for (let apiVersion of versionsArray) {
          ...
          if (
            ...
            let typesFile = await $axios.$get(
              "https://https://hapi-tsdocs.netlify/type-docs/modules/_" +
                params.family +
                "_" +
            ...
            if (moduleList) {
              ...
              for (let m of modules) {
                ...
                let moduleMD = await $axios.$get(
                  "https://hapi-tsdocs.netlify/type-docs/modules/" + fileName[0]
                );
                moduleMD = moduleMD + "##";
                    ...
                    if (interfaces) {
                      for (let i of interfaces) {
                        ...
                        let interfaceFile = await $axios.$get(
                          "https://hapi-tsdocs.netlify/type-docs/interfaces/" + interfaceName[0]
                        );
            ...
            let functions = await $axios.$get(
              "https://hapi-tsdocs.netlify/type-docs/modules/_" +
                params.family +
                "_" +
                apiVersion.replace(/\./g, "_") +
                "_index_d_.md",
            ...
            if (interfaces) {
              ...
              for (let name of interfaceName) {
                let interfaceFile = await $axios.$get(
                  "https://hapi-tsdocs.netlify/type-docs/interfaces/" + name
                );
                interfaceFile = interfaceFile + "#";
