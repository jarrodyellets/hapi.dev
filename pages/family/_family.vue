        ...
        for (let head of headers) {
          ...
          if (id in this.moduleAPI[this.$route.params.family].types[this.getVersion]) {
            if (
              ...
              document.querySelector('#' + id + ' p').outerHTML = this.moduleAPI[this.$route.params.family].types[
                this.getVersion
              ][id];
            } else {
              wrapper.insertAdjacentHTML(
                'afterbegin',
                this.moduleAPI[this.$route.params.family].types[this.getVersion][id]
              );
            }
            if (ul) {
              ul.outerHTML = '';
      ...
      try {
        ...
        for (let apiVersion of versionsArray) {
          ...
          if (
            ...
            (moduleAPI[params.family].types[apiVersion] || moduleAPI[params.family].versions[apiVersion] === 'master')
          ) {
            ...
            if (moduleList) {
              ...
              for (let m of modules) {
                ...
                let moduleMD = await $axios.$get('https://hapi-tsdocs.netlify.com/type-docs/modules/' + fileName[0]);
                moduleMD = moduleMD + '##';
                      ...
                      for (let i of interfaces) {
                        ...
                        if (interfaceMethods) {
                          ...
                          for (let interfaceMethod of interfaceMethods) {
                            ...
                            moduleAPI[params.family].types[apiVersion][title] = await interfaceMethodHTML;
                          }
                        }
                      }
                    }
            ...
            if (classList) {
              ...
              for (let c of classes) {
                ...
                moduleAPI[params.family].types[apiVersion][title] = await classHTML;
                if (classMethods) {
                  let interfaces = {};
                  let finalMethods = '';
                  ...
                  for (let classMethod of classMethods) {
                    ...
                    moduleAPI[params.family].types[apiVersion][classMethodTitle] = await classMethodHTML;
                  }
                }
              }
            }
                  ...
                  for (let key in interfaces) {
                    ...
                    for (let file of interfaceFile) {
                      let interfaceCode = await $axios.$get(
                        'https://hapi-tsdocs.netlify.com/type-docs/interfaces/' + file
                      );
